...
export const metadata = {
  title: "Dom modułowy 40m² (10x4m) | Pawilony Fidens.pl",
  description:
    "Dom modułowy 40m², wymiary 10x4m. Realizacja z płyty warstwowej — sprawdź szczegóły i orientacyjną ratę w leasingu.",
};

const SLUG = "dom-modulowy-40m2-10x4m";
const NAZWA = "Dom modułowy 40m²";
const CENA = 150000;
            ...
            <div className="rounded-xl p-6 mb-6 mt-6" style={{ backgroundColor: "#ffffff", border: "1px solid #e8eaed" }}>
              ...
              <dl className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-3">
                <div className="flex justify-between border-b pb-2" style={{ borderColor: "#f0f0f0" }}>
                  ...
                  <dd className="text-sm font-semibold" style={{ color: "#1B2A4A" }}>10m &times; 4m</dd>
                </div>
                <div className="flex justify-between border-b pb-2" style={{ borderColor: "#f0f0f0" }}>
                  <dt className="text-sm" style={{ color: "#888" }}>Powierzchnia</dt>
                  <dd className="text-sm font-semibold" style={{ color: "#1B2A4A" }}>40 m&sup2;</dd>
                </div>
              </dl>
            </div>
