...
- Name: navbar.spec.ts >> Navbar >> desktop - kliknięcie w Pawilony przenosi do /pawilony
- Location: tests\navbar.spec.ts:19:7
...
Call log:
  - waiting for getByRole('link', { name: 'Pawilony', exact: true })
    - locator resolved to <a href="/pawilony">Pawilony</a>
